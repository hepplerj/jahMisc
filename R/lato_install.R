...
#'
#' Note: Lato must be installed on your computer for \code{lato_install} to work. Lato can be installed from \href{https://fonts.google.com/specimen/Lato}{Google fonts}.
#'
